...
{
    MP4Err err;
    DRCUniDrcSampleEntryAtomPtr self;
    err = MP4NoErr;
    self = (DRCUniDrcSampleEntryAtomPtr) s;
...
{
    MP4Err err;
    DRCUniDrcSampleEntryAtomPtr self = (DRCUniDrcSampleEntryAtomPtr) s;
    err = MP4NoErr;
...
MP4Err MP4CreateDRCUniDrcSampleEntryAtom( DRCUniDrcSampleEntryAtomPtr *outAtom )
{
    ...
    self = (DRCUniDrcSampleEntryAtomPtr) calloc( 1, sizeof(DRCUniDrcSampleEntryAtom) );
    TESTMALLOC( self )
    
    err = MP4CreateBaseAtom( (MP4AtomPtr) self );
    if ( err ) goto bail;
    self->type                  = DRCUniDrcSampleEntryAtomType;
    self->name                  = "Uni DRC sample entry";
