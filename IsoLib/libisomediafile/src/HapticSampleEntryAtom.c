...
{
  MP4Err err;
  MP4HapticSampleEntryAtomPtr self;
  err  = MP4NoErr;
  self = (MP4HapticSampleEntryAtomPtr)s;
...
{
  MP4Err err;
  MP4HapticSampleEntryAtomPtr self = (MP4HapticSampleEntryAtomPtr)s;
  err                              = MP4NoErr;
...
MP4Err MP4CreateHapticSampleEntryAtom(MP4HapticSampleEntryAtomPtr *outAtom)
{
  ...
  self = (MP4HapticSampleEntryAtomPtr)calloc(1, sizeof(MP4HapticSampleEntryAtom));
  TESTMALLOC(self)

  err = MP4CreateBaseAtom((MP4AtomPtr)self);
  if(err) goto bail;
  self->type = 0; /* This is an abstract sample entry */
  self->name = "HapticSampleEntry";
