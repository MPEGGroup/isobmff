...
*/
/*
        $Id: MP4ES_ID_IncDescriptor.c,v 1.1.1.1 2002/09/20 08:53:35 julien Exp $
*/
...
{
  MP4Err err;
  MP4ES_ID_IncDescriptorPtr self = (MP4ES_ID_IncDescriptorPtr)s;
  err                            = MP4NoErr;
...
static void destroy(struct MP4DescriptorRecord *self) { free(self); }

MP4Err MP4CreateES_ID_IncDescriptor(u32 tag, u32 size, u32 bytesRead, MP4DescriptorPtr *outDesc)
{
  SETUP_BASE_DESCRIPTOR(MP4ES_ID_IncDescriptor)
