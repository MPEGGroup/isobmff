...
QTNewMovie(ISOMovie *outMovie)
{
  ...
  if(err) goto bail;
  err = ftyp->setBrand(ftyp, ISOQuickTimeBrand, 0);
  if(err) goto bail;
...
New3GPPMovie(ISOMovie *outMovie, u16 release)
{
  ...
  {
  case 4:
    err = ftyp->setBrand(ftyp, ISO3GP4Brand, 0);
    if(err) goto bail;
    break;
  case 5:
    err = ftyp->setBrand(ftyp, ISO3GP5Brand, 0);
    if(err) goto bail;
    break;
  case 6:
    err = ftyp->setBrand(ftyp, ISO3GP6Brand, 0);
    if(err) goto bail;
    break;
  default:
