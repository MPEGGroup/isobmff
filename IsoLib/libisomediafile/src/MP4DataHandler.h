...
#define COMMON_DATAHANDLER_FIELDS                                                         \
  MP4Err (*open)(struct MP4DataHandler * self, struct MP4InputStreamRecord * inputStream, \
...
MP4Err MP4CreateDataHandler(struct MP4InputStreamRecord *inputStream, MP4DataEntryAtomPtr dataEntry,
