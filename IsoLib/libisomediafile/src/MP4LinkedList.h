...
*/
/*
	$Id: MP4LinkedList.h,v 1.1.1.1 2002/09/20 08:53:35 julien Exp $
*/
#ifndef INCLUDED_MP4_LINKED_LIST_H
#define INCLUDED_MP4_LINKED_LIST_H

#include "MP4Movies.h"


typedef struct MP4ListItem
{
	struct MP4ListItem* link;
	void *data;
} MP4ListItem, *MP4ListItemPtr;

typedef struct MP4List
{
	struct MP4ListItem *head;
	struct MP4ListItem *tail;
	u32                 entryCount;
	int                 foundEntryNumber;
	struct MP4ListItem *foundEntry;
} MP4List, *MP4LinkedList;
