...
#pragma export on
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4GetMovieInitialObjectDescriptor(MP4Movie theMovie, 
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4GetMovieInitialObjectDescriptorUsingSLConfig(MP4Movie theMovie, 
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4GetMovieProfilesAndLevels(MP4Movie theMovie, u8 *outOD, u8 *outScene, 
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4NewMovie(MP4Movie *outMovie, u32 initialODID, u8 OD_profileAndLevel, 
                                 u8 scene_profileAndLevel, u8 audio_profileAndLevel, 
                                 u8 visual_profileAndLevel, u8 graphics_profileAndLevel);
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) ISONewMetaMovie(MP4Movie *outMovie, u32 handlertype, u32 brand, 
                                     u32 minorversion);
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4AddTrackReference(MP4Track theTrack, MP4Track dependsOn, u32 referenceType,
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4AddTrackReferenceWithID(MP4Track theTrack, u32 dependsOnID, 
                                                u32 dependencyType, u32 *outReferenceIndex);
  /**
   * @brief 
   * 
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4GetSubSampleInformationEntryFromTrack(MP4Track theTrack, u32 *flags, 
      u32 *entry_count, u32 **sample_delta, u32 **subsample_count, u32 ***subsample_size_array,
      u32 ***subsample_priority_array, u32 ***subsample_discardable_array);
  /**
   * @brief 
   * 
   * @param subsample 
  ...
  */
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4GetTrackReference(MP4Track theTrack, u32 referenceType, u32 referenceIndex,
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4GetTrackReferenceCount(MP4Track theTrack, u32 referenceType, 
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4InsertMediaIntoTrack(MP4Track trak, s32 trackStartTime, s32 mediaStartTime,
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4NewMovieTrackWithID(MP4Movie theMovie, u32 newTrackFlags, u32 newTrackID, 
                                            MP4Track *outTrack);
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4NewTrackMedia(MP4Track theTrack, MP4Media *outMedia, u32 handlerType, 
                                      u32 timeScale, MP4Handle dataReference);
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4AddMediaDataReference(MP4Media theMedia, u32 *outReferenceIndex, 
                                              MP4Handle urlHandle, MP4Handle urnHandle);
  /**
  ...
  MP4_EXTERN(MP4Err) MP4AddMediaSampleReference(MP4Media media, u64 dataOffset, u32 sampleCount, 
                                                MP4Handle durationsH, MP4Handle sizesH, 
  ...
  MP4_EXTERN(MP4Err) MP4AddMediaSampleReferencePad(MP4Media media, u64 dataOffset, u32 sampleCount,
      MP4Handle durationsH, MP4Handle sizesH, MP4Handle sampleEntryH, MP4Handle decodingOffsetsH, 
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) ISOAddGroupDescription(MP4Media media, u32 groupType, MP4Handle description, 
                                            u32 *index);
  /**
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) ISOGetGroupDescription(MP4Media media, u32 groupType, u32 index, 
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) ISOGetGroupDescriptionEntryCount(MP4Media media, u32 groupType, 
                                                      u32 *outEntryCount);
  /**
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) ISOSetSamplestoGroupType(MP4Media media, 
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) ISOMapSamplestoGroup(MP4Media media, u32 groupType, u32 group_index, 
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) ISOGetSampletoGroupMap(MP4Media media, u32 groupType, u32 sample_number, 
                                            u32 *group_index);
  /**
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) ISOGetSampleGroupSampleNumbers(MP4Media media, u32 groupType, u32 group_index,
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) ISOSetSampleDependency(MP4Media media, s32 sample_index, 
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) MP4GetIndMediaSampleWithPad(MP4Media theMedia, u32 sampleNumber, 
      MP4Handle outSample, u32 *outSize, u64 *outDTS, s32 *outCTSOffset, u64 *outDuration,
   ...
   */
  MP4_EXTERN(MP4Err) MP4GetIndMediaSample(MP4Media theMedia, u32 sampleNumber, MP4Handle outSample, 
      u32 *outSize, u64 *outDTS, s32 *outCTSOffset, u64 *outDuration, u32 *outSampleFlags, 
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) MP4GetIndMediaSampleReference(MP4Media theMedia, u32 sampleNumber, 
      u32 *outOffset, u32 *outSize, u32 *outDuration, u32 *outSampleFlags, u32 *outSampleDescIndex,
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) MP4GetMediaDataReference(MP4Media theMedia, u32 index, MP4Handle referenceURL,
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) MP4GetMediaHandlerDescription(MP4Media theMedia, u32 *outType, 
                                                   MP4Handle *outName);
  /**
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) MP4GetMediaNextInterestingTime(MP4Media theMedia, u32 interestingTimeFlags,
                                                    u64 searchFromTime,u32 searchDirection,
  ...
  MP4_EXTERN(MP4Err) MP4GetMediaSample(MP4Media theMedia, MP4Handle outSample, u32 *outSize, 
      ...
      MP4Handle outSampleDescription, u32 *outSampleDescriptionIndex, u32 *outSampleFlags);
  /**
  ...
  MP4_EXTERN(MP4Err) MP4MediaTimeToSampleNum(MP4Media theMedia, u64 mediaTime, u32 *outSampleNum, 
                                             u64 *outSampleCTS, u64 *outSampleDTS, 
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) MP4SampleNumToMediaTime(MP4Media theMedia, u32 sampleNum, u64 *outSampleCTS, 
   ...
   */
  MP4_EXTERN(MP4Err) MP4GetMediaDecoderConfig(MP4Media theMedia, u32 sampleDescIndex, 
   ...
   */
  MP4_EXTERN(MP4Err) MP4GetMediaDecoderInformation(MP4Media theMedia, u32 sampleDescIndex, 
      u32 *outObjectType, u32 *outStreamType, u32 *outBufferSize, u32 *outUpstream,
  ...
  MP4_EXTERN(MP4Err) MP4GetMediaDecoderType(MP4Media theMedia, u32 sampleDescIndex, 
      u32 *outObjectType, u32 *outStreamType, u32 *outBufferSize, MP4Handle specificInfoH);
   ...
   * length fields.
   */
  MP4_EXTERN(MP4Err) MP4NewSampleDescription(MP4Track theTrack, MP4Handle sampleDescriptionH, 
      u32 dataReferenceIndex, u32 objectTypeIndication, u32 streamType, u32 decoderBufferSize,
  ...
  MP4_EXTERN(MP4Err) MP4NewSampleDescriptionWithOCRAssociation(MP4Track theTrack, 
      MP4Handle sampleDescriptionH, u32 dataReferenceIndex, u32 objectTypeIndication,
      u32 streamType, u32 decoderBufferSize, u32 maxBitrate, u32 avgBitrate, 
      MP4Handle decoderSpecificInfoH, u32 theOCRESID);
   ...
   */
  MP4_EXTERN(MP4Err) ISOAddAtomToSampleDescription(MP4Handle sampleEntryH, 
                                                   MP4GenericAtom extensionAtom);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) ISOGetAtomFromSampleDescription(MP4Handle sampleEntryH, u32 atomType, 
  ...
  MP4_EXTERN(MP4Err) ISONewXMLMetaDataSampleDescription(MP4Track theTrack, 
      MP4Handle sampleDescriptionH, u32 dataReferenceIndex, char *content_encoding,
   ...
   */
  MP4_EXTERN(MP4Err) MP4TrackReaderGetCurrentDecoderConfig(MP4TrackReader theReader, 
                                                           MP4Handle decoderConfigH);
  /**
   * @brief Get the sample description associated with the current read-point.
   */
  MP4_EXTERN(MP4Err) MP4TrackReaderGetCurrentSampleDescription(MP4TrackReader theReader, 
                                                               MP4Handle sampleEntryH);
  /**
   * @brief Get the index of the current sample description.
   */
  MP4_EXTERN(MP4Err) MP4TrackReaderGetCurrentSampleDescriptionIndex(MP4TrackReader theReader, 
                                                                    u32 *index);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) MP4TrackReaderGetNextAccessUnit(MP4TrackReader theReader, 
      MP4Handle outAccessUnit, u32 *outSize, u32 *outSampleFlags, s32 *outCTS, s32 *outDTS);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) MP4TrackReaderGetNextAccessUnitWithDuration(MP4TrackReader theReader, 
      MP4Handle outAccessUnit, u32 *outSize, u32 *outSampleFlags, s32 *outCTS, s32 *outDTS, 
      u32 *outDuration);
  /**
   ...
   * @see MP4TrackReaderGetNextAccessUnit
   */
  MP4_EXTERN(MP4Err) MP4TrackReaderGetNextAccessUnitWithPad(MP4TrackReader theReader, 
      MP4Handle outAccessUnit, u32 *outSize, u32 *outSampleFlags, s32 *outCTS, s32 *outDTS, 
      u8 *outPad);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) MP4TrackReaderGetNextPacket(MP4TrackReader theReader, MP4Handle outPacket, 
                                                 u32 *outSize);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) MP4TrackReaderGetCurrentSampleNumber(MP4TrackReader theReader, 
                                                          u32 *sampleNumber);
   ...
   */
  MP4_EXTERN(MP4Err) MP4SetupSampleAuxiliaryInformation(MP4Media theMedia, 
      u8 isUsingAuxInfoPropertiesFlag, u32 aux_info_type, u32 aux_info_type_parameter,
   ...
   * parameters.
   */
  MP4_EXTERN(MP4Err) MP4AddSampleAuxiliaryInformation(MP4Media theMedia, 
      u8 isUsingAuxInfoPropertiesFlag, u32 aux_info_type, u32 aux_info_type_parameter, 
   ...
   */
  MP4_EXTERN(MP4Err) MP4GetSampleAuxiliaryInformation(MP4Media theMedia, u32 *outCount,
   ...
   */
  MP4_EXTERN(MP4Err) MP4GetSampleAuxiliaryInformationForSample(MP4Media theMedia, 
      u8 isUsingAuxInfoPropertiesFlag, u32 aux_info_type, u32 aux_info_type_parameter,
   ...
   */
  MP4_EXTERN(MP4Err) MP4AddUserData(MP4UserData theUserData, MP4Handle dataH, u32 userDataType, 
                                    u32 *outIndex);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) MP4GetUserDataEntryCount(MP4UserData theUserData, u32 userDataType, 
                                              u32 *outCount);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) MP4GetUserDataItem(MP4UserData theUserData, MP4Handle dataH, u32 userDataType, 
                                        u32 itemIndex);
  /**
   * @brief Returns the contents of the requested user data item.
   * 
   ...
   * @param itemIndex The index for the atom type you are querying. This should be one based
   */
  MP4_EXTERN(MP4Err) MP4GetAtomFromUserData(MP4UserData theUserData, MP4GenericAtom *outAtom, 
   ...
   */
  MP4_EXTERN(MP4Err) MP4DeleteUserDataItem(MP4UserData theUserData, u32 userDataType, 
                                           u32 itemIndex);
  /**
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4NewForeignAtom(MP4GenericAtom *outAtom, u32 atomType, 
   ...
   * @return MP4Err error code
   */
  MP4_EXTERN(MP4Err) MP4NewUUIDAtom(MP4GenericAtom *outAtom, u8 the_uuid[16], 
                                    MP4Handle atomPayload);
  /**
   * @brief Returns the type and contents of the given foreign atom, and, if it is a UUID atom, its 
   * UUID also.
   */
  MP4_EXTERN(MP4Err) MP4GetForeignAtom(MP4GenericAtom atom, u32 *atomType, u8 the_uuid[16], 
                                       MP4Handle atomPayload);
...
#include "ISOMovies.h"
   ...
   * @ingroup SampleDescr
   */
  MP4_EXTERN(MP4Err) ISOGetSampleDescriptionDimensions(MP4Handle sampleEntryH, u16 *width, 
                                                       u16 *height);
  /**
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) ISOSetTrackFragmentDefaults(MP4Track theTrack, u32 duration, u32 size, 
                                                 u32 is_sync, u8 pad);
  /**
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) ISOSetCompositonToDecodePropertiesForFragments(MP4Movie theMovie, u32 trackID,
      s32 compositionToDTSShift, s32 leastDecodeToDisplayDelta, s32 greatestDecodeToDisplayDelta,
   ...
   */
  MP4_EXTERN(MP4Err) MP4NewIPMPTool(MP4Handle ipmpToolH, u64 ipmpToolIdLowerPart, 
      u64 ipmpToolIdUpperPart, MP4Handle altGroupInfoH, MP4Handle parametricInfoH);
  /**
   ...
   * Pointer
   */
  MP4_EXTERN(MP4Err) MP4NewIPMPDescriptorPointer(MP4Handle ipmpDescPtrH, u8 ipmpDescriptorId, 
                                                 u16 ipmpToolDescrId);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) MP4NewIPMPToolDescriptor(MP4Handle ipmpToolDescH, u16 ipmpToolDescrId, 
      u64 ipmpToolIdLowerPart, u64 ipmpToolIdUpperPart, MP4Handle ipmpInitializeH);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) MP4NewIPMPInitialize(MP4Handle ipmpInitializeH, u8 controlPoint, 
                                          u8 sequenceCode);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) MP4AddIPMPDataToIPMPToolDescriptor(MP4Handle ipmpToolDescrH, 
                                                        MP4Handle ipmpDataH);
  /**
   ...
   */
  MP4_EXTERN(MP4Err) MP4AddIPMPToolDescriptorToUpdate(MP4Handle ipmpToolDescrUpdateH, 
  ...
  MP4_EXTERN(MP4Err) ISMATransformSampleEntry(u32 newTrackFlags, MP4Handle insampleEntryH, 
      u8 selective_encryption, u8 key_indicator_length, u8 IV_length, char *kms_URL, 
   ...
   */
  MP4_EXTERN(MP4Err) ISMAUnTransformSampleEntry(MP4Handle insampleEntryH, u8 *selective_encryption,
  ...
  MP4_EXTERN(MP4Err) ISMATransformSampleEntrySalt(u32 newTrackFlags, MP4Handle insampleEntryH, 
      u8 selective_encryption, u8 key_indicator_length, u8 IV_length, char *kms_URL, u64 salt,
      MP4Handle outsampleEntryH);
  /**
   * @brief ‘Untransforms’ a sample entry, from the encrypted form to the standard form.
   * 
...
#define ISMA_selective_encrypt 0x80
   ...
   * @return MP4Err error code 
   */
  MP4_EXTERN(MP4Err) MP4GetTrackEditlist(MP4Track theTrack, u64 *outSegmentDuration, 
                                         s64 *outMediaTime, u32 entryIndex );
