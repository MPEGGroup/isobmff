...
#include "ISOMovies.h"
  ...
  /* JB_RESO 09/02 adding support for IPMPX */
  MP4_EXTERN(MP4Err)
  MP4AddUrlToIPMPTool(MP4Handle ipmpToolH, MP4Handle urlH);
  ...
  /* JB_RESO 09/02 adding support for IPMPX */
  MP4_EXTERN(MP4Err)
  MP4AddToolToIPMPToolList(MP4Handle ipmpToolListDescrH, MP4Handle ipmpToolH);
  ...
  /* JB_RESO 09/02 adding support for IPMPX */
  MP4_EXTERN(MP4Err)
  MP4AddIPMPDataToIPMPInitialize(MP4Handle ipmpInitializeH, MP4Handle ipmpDataH);
...
#define ISMA_selective_encrypt 0x80
  ...
  MP4GetTrackEditlist(MP4Track theTrack, u64 *outSegmentDuration, s64 *outMediaTime,
                      u32 entryIndex /* index is one based */);
