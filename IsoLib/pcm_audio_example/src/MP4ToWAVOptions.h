 ...
 */
typedef struct MP4ToWAVOptionsStruct
{
    char    *inputFile;
    char    *outputFile;
 ...
 */
static inline void setDefaultValues (MP4ToWAVOptions *options)
{
...
{
    printf("\n=============================================\n");
    printf("MPEG-4 File Format to WAV Converter\n");
    printf("based on ISO/IEC 14496-12 and ISO/IEC 23003-5\n");
    printf("Version 0.1 (2019)\n");
    printf("Purpose: Convert a mono or stereo MP4 file into a WAV file.");
    printf("\nUsage:\n");
    printf("\t-h\t\tPrints this usage help.\n");
    printf("\t-i\t\tMPEG-4 input file (mandatory)\n");
    printf("\t-o\t\tWAV output file (mandatory)\n");
    ...
    printf("\nExample:\n");
    printf("\tMP4_to_WAV -i input.mp4 -o output.wav -d 3\n");
    printf("\n=============================================\n");
}
 ...
 * @param options Pointer to an option structure
 */
static inline void printOptions     (MP4ToWAVOptions *options)
{
    logMsg(LOGLEVEL_INFO, "MPEG-4 input file: %s", options->inputFile);
    logMsg(LOGLEVEL_INFO, "WAV output file: %s", options->outputFile);
}
 ...
 * @param options Pointer to an option structure
 */
static inline void freeOptions     (MP4ToWAVOptions *options)
{
 ...
 */
static inline bool parseArguments   (int argc, char **argv, MP4ToWAVOptions *options)
{
