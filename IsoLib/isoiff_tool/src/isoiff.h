...
/*!
 * @discussion Collects all images of a given type from an image collections and presents the result
 * as an array
 * @param collection The image collection
...
/*!
 * @discussion Collects all meta items of a given type from an image collections and presents the
 * result as an array
 * @param collection The image collection
...
/*!
 * @discussion Sets an image as the cover image of its collection. (This means it will become the
 * primary item)
...
/*!
 * @discussion Adds a meta item to an image (This means there will be a relation from the image to
 * the meta item)
...
/*!
 * @discussion Adds a image to an meta item (This means there will be a relation from the meta item
 * to the image)
 ...
 * @param fromImage The image from which the relations of the type relationType point to the
 * toImages
 * @param relationType The 4cc relation type
 * @param toImages This array will be allocated and filled with images found for the fromImage's
 * relations
 ...
 * @param relationType The 4cc relation type
 * @param toMetas This array will be allocated and filled with meta items found for the fromImage's
 * relations
 ...
 * @param fromMeta The meta item from which the relations of the type relationType point to the
 * toImages
 * @param relationType The 4cc relation type
 * @param toImages This array will be allocated and filled with images found for the fromMeta's
 * relations
 * @param numberOfImagesFound The number of images in toImages
 */
